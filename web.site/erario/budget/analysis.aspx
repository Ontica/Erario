...
<%@ Page language="c#" CodeFile="analysis.aspx.cs" AutoEventWireup="false" Inherits="Empiria.WebApp.Erario.Budget.AnalysisPage" %>
...
<HTML>
	<HEAD>
		...
		<!--			
			...
			function doOperation(operationTag) {
				document.frmEditor.hdnOperationTag.value = operationTag;
				switch (operationTag) {
					case "Generate":
						if (!bSended) {
							if (validate()) {
			...
			function setSearcher(changeIt) {
				if (changeIt) {
					window.parent.execScript('setRightToolbarContainer()');
				}
				var result = window.parent.document.all.rightToolbarContainer.style.display;
				if (result == 'inline') {							
					document.all.spnSearchBtnText.innerText = "Ocultar buscador";
				} else {
					document.all.spnSearchBtnText.innerText = "Mostrar buscador";
				}			
			}
	...
	<body oncontextmenu="return true;" MS_POSITIONING="GridLayout" onload="return window_onload();">
					...
					<td noWrap width="100%">
						<table style="WIDTH: 100%" cellSpacing="2" cellPadding="2">
							<TR height="10">
								...
								<td style="HEIGHT: 17px" noWrap align="left" width="100%"><A href="javascript:doOperation('Generate');"><IMG hspace="6" src="../../images/detail.gif" align="absMiddle">Generar</A>
								</td>
							</TR>
							<TR>
								...
								<TD style="HEIGHT: 22px" noWrap>
									<SELECT id="cboGroup3" style="WIDTH: 192px" name="cboGroup3" runat="server">
								...
								<TD style="HEIGHT: 22px" noWrap>
									<A href="javascript:doOperation('SetSearcher')"><IMG src="../../images/icons/search_sm.gif" hspace="6" align="absMiddle"><span id="spnSearchBtnText">Mostrar 
											buscador</span></A>
								</TD>
							</TR>
							<TR>
								...
								<td vAlign="top" width="100%">
									<div style="OVERFLOW: auto; WIDTH: 100%; HEIGHT: 100%">
										<asp:datagrid id="grdItems" tabIndex="-1" runat="server" AutoGenerateColumns="False" Width="100%"
											...
											<Columns>
												<asp:BoundColumn DataField="ClassId" DataFormatString="&lt;img class=imageButton src='../../images/icons_sm/document_sm.gif'; onclick=&quot;return doOperation('Detail', {0})&quot;&gt;"></asp:BoundColumn>
												...
												<asp:BoundColumn DataField="Comp20062005" SortExpression="Comp20062005 ASC" HeaderText="Comp 2006-2005"
